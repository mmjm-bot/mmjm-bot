...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:MMJM\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5521985857877:+55 219858578776\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD MMJM BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Causs? Este é um recurso especial para o MMJM ❌',
					ownerB: '[❗] Causs? Este é um recurso especial para o MMJM ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de CAUSS. Registre-se para fazer amizade com o bot MMJM por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Causs|17\n\n──「 MMJM BOT 」──`,
			...
			const ownerNumber = ["554792091566@s.whatsapp.net","5521985857877@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"554792091566@s.whatsapp.net","5521985857877@s.whatsapp.net"]//ubah nomor lo
			...
			const premium = ["554792091566@s.whatsapp.net","55219858578770@s.whatsapp.net","55219950271178"] 
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS MMJM BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @MMJM domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o MMJM ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT MMJM ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *CAUSS* 」*────*\n\n*_SE QUER SER ADMIN DO BOT CAUSS_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* MIGUEL\n*YOUTUBE:*OFF\n*WPP:* wa.me/+5521985857877\n*INSTA:*MMJM\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
